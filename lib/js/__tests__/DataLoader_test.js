...
describe("Primary API", (function () {
        ...
        Jest.testPromise("it builds a really simple data loader", (function () {
                var IdentityLoader = DataLoader.Make(IdentityLoaderImpl);
                return Curry._1(IdentityLoader[/* load */12], "1").then((function (loadedVal) {
                              return Promise.resolve(Jest.Expect[/* toBe */1]("1")(Jest.Expect[/* expect */0](loadedVal)));
                            }));
              }));
        Jest.testPromise("it supports loading multiple keys in one call", (function () {
                var IdentityLoader = DataLoader.Make(IdentityLoaderImpl);
        ...
        Jest.testPromise("it batches multiple requests", (function () {
                var IdentityLoader = DataLoader.Make(IdentityLoaderImpl);
        ...
        Jest.testPromise("it batches multiple requests with max batch sizes", (function () {
                var calls = /* array */[];
                var batchLoadFun = function (strings) {
                  calls.push(strings);
                  return Promise.resolve($$Array.map((function (string) {
                ...
                return Promise.all(/* array */[
                              ...
                              return Promise.resolve(Jest.Expect[/* toEqual */11](/* tuple */[
                                                /* array */[
                                                  "1",
                                                  "2",
                                                  "3"
        ...
        return Jest.testPromise("coalesces identical requests", (function () {
                      var calls = /* array */[];
                      var batchLoadFun = function (strings) {
                        calls.push(strings);
                        return Promise.resolve($$Array.map((function (string) {
...
describe("caches repeated requests", (function () {
        ...
        var IdentityLoader = DataLoader.Make(IdentityLoaderBatchImpl);
        Jest.testPromise("initial call", (function () {
        ...
        return Jest.testPromise("repeted requests", (function () {
...
describe("clear single value", (function () {
        ...
        var IdentityLoader = DataLoader.Make(IdentityLoaderImpl);
        Jest.testPromise("can get a value", (function () {
                var load1a = Curry._1(IdentityLoader[/* load */12], "1");
        ...
        return Jest.testPromise("clears single value in loader", (function () {
...
describe("clear all values", (function () {
        ...
        var IdentityLoader = DataLoader.Make(IdentityLoaderImpl);
        Jest.testPromise("loads initial data", (function () {
                var load1a = Curry._1(IdentityLoader[/* load */12], "1");
                var load2a = Curry._1(IdentityLoader[/* load */12], "2");
                return Promise.all(/* array */[
                              load1a,
        ...
        return Jest.testPromise("clears all values in loader", (function () {
...
describe("Priming the cache", (function () {
        Jest.testPromise("it allows priming the cache", (function () {
                var calls = /* array */[];
                var batchLoadFun = function (strings) {
                  calls.push(strings);
                  return Promise.resolve($$Array.map((function (string) {
        ...
        return Jest.testPromise("it does not prime keys that already exist", (function () {
                      var batchLoadFun = function (strings) {
                        return Promise.resolve($$Array.map((function (string) {
                                          return /* Ok */Block.__(0, [string]);
                                        }), strings));
...
describe("Priming the cache by force", (function () {
        ...
        var IdentityLoader = DataLoader.Make(IdentityLoaderImpl);
        Jest.testPromise("allows priming the cache", (function () {
                Curry._2(IdentityLoader[/* prime */8], "1", "A");
                var load1a = Curry._1(IdentityLoader[/* load */12], "1");
                var load2a = Curry._1(IdentityLoader[/* load */12], "2");
                return Promise.all(/* array */[
        ...
        return Jest.testPromise("allows forcefully priming the cache", (function () {
                      Curry._1(IdentityLoader[/* clear */6], "1");
