  ...
  () => {
    ...
    testPromise(
      ...
      () => {
        ...
        let load2 =
          IdentityLoader.load("2") |> Js.Promise.catch((_) => Js.Promise.resolve("error"));
  ...
  () => {
    ...
    testPromise(
      ...
      () => {
        ...
        |> Js.Promise.then_(
             (loadedValue) => Js.Promise.resolve(expect(loadedValue) |> toEqual("error"))
           )
      }
    );
    testPromise(
      ...
      () => {
        ...
        |> Js.Promise.catch((_) => Js.Promise.resolve("error"))
        |> Js.Promise.then_(
             (loadedValue) => Js.Promise.resolve(expect(loadedValue) |> toEqual("1"))
           )
      }
    )
  }
